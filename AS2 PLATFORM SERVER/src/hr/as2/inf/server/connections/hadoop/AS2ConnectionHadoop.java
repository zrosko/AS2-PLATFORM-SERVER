package hr.as2.inf.server.connections.hadoop;
 ...
 * zrosko@gmail.com
 */
public final class AS2ConnectionHadoop extends J2EEConnection {
   
    public AS2ConnectionHadoop(J2EEConnectionManager aConnectionManager, String host, String user, String password) throws AS2Exception {
