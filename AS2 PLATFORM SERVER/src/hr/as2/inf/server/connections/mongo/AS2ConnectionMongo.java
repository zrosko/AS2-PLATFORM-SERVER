package hr.as2.inf.server.connections.mongo;
 ...
 * zrosko@gmail.com
 */
public final class AS2ConnectionMongo extends J2EEConnection {
   
    public AS2ConnectionMongo(J2EEConnectionManager aConnectionManager, String host, String user, String password) throws AS2Exception {
