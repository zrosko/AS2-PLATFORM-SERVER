...
public class J2EEJDBCService extends J2EEPersistentService {
	static private J2EEJDBCService _instance = null;
public J2EEJDBCService() {
	super();
...
public static J2EEJDBCService getInstance(){
	if(_instance==null)
		_instance = new J2EEJDBCService();
	return _instance;
}
}
