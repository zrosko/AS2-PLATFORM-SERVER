...
public final class AS2TransactionJdbc extends J2EEJdbc {
    private String SQL_FIND = "SELECT * FROM j2ee_transaction ORDER BY transaction_id DESC";
    private String SQL_FIND_IF_EXIST = "SELECT * FROM j2ee_transaction WHERE (transaction_id = ?) ";
    
    public AS2TransactionJdbc() {
        setTableName("j2ee_transaction");
    }
    public AS2TransactionRs daoReadAll(AS2TransactionVo value) throws AS2DataAccessException {
